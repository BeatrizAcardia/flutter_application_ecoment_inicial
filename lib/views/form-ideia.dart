...
class _FormIdeiaState extends State<FormIdeia> {
  ...
  TextStyle labels = TextStyle(
      fontFamily: 'Nunito', fontWeight: FontWeight.bold, fontSize: 18, color: Colors.black);
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    espacoH10,
                    Row(children: [criaLabel('Nome da ideia: ')]),
                    espacoH5,
                    TextFormField(
                      controller: ctrlNome,
                      maxLength: 80,
                    ...
                    Row(
                      children: [
                        Expanded(
                          ...
                          children: [
                            Row(
                              children: [criaLabel('Descrição da ideia: ')],
                            ),
                            espacoH5,
                            TextFormField(
                    ...
                    Row(
                      children: [
                        Expanded(
                          ...
                          children: [
                            Row(
                              children: [criaLabel('Materiais necessários: ')],
                            ),
                            espacoH5,
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                  hintText: 'Informe tudo o que vamos precisar...',
                                  hintStyle: nunito,
                                  border: OutlineInputBorder(
                                      borderRadius: BorderRadius.circular(10))),
                            ),
                    ...
                    espacoH10,
                    Row(
                      children: [criaLabel('Dificuldade: ')],
                    ),
                    FormField(
                      initialValue: '',
                      validator: (value) {
                              ...
                              children: [
                                Expanded(
                                  child: RadioListTile(
                                    ...
                                    activeColor: Color.fromARGB(255, 78, 158, 90),
                                    onChanged: (value) {
                                      dificuldade = value!;
                                ...
                                Expanded(
                                  child: RadioListTile(
                                    ...
                                    value: '2',
                                    groupValue: dificuldade,
                                    activeColor: Color.fromARGB(255, 255, 188, 54),
                                    onChanged: (value) {
                                      dificuldade = value!;
                                      field2.didChange(value);
                                      setState(() {});
                                ...
                                Expanded(
                                  child: RadioListTile(
                                    ...
                                    value: '3',
                                    groupValue: dificuldade,
                                    activeColor: Color.fromARGB(255, 207, 18, 18),
                                    onChanged: (value) {
                                      dificuldade = value!;
                                      field2.didChange(value);
                                      setState(() {});
                        ...
                        if (chave.currentState!.validate()) {
                          showDialog(
                              ...
                              builder: (context) => CupertinoAlertDialog(
                                    title: Text('Postagem realizada com sucesso!', style: nunito,),
                                    content: Text('Obrigado pela contribuição!', style: nunito,),
                                    actions: [
                          ...
                          postar(ctrlNome.text, material, ctrlDescricao.text,
                              ctrlInstrucoes.text, ctrlMateriais.text, dificuldade);
                          print('--------- IDEIAS ---------');
                          ...
                          showDialog(
                              context: context,
                              builder: (context) => CupertinoAlertDialog(
                                    title: Text('Erro ao concluir a postagem!', style: nunito,),
                                    content: Text('Dados já existentes ou incompletos.', style: nunito,),
                                    actions: [
                                      CupertinoDialogAction(
                                        child: Text('OK', style: nunito),
                                        onPressed: () =>
