          ...
          children: [
            DrawerHeader(
              ...
              child: Column(children: [
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [Align(alignment: Alignment.center, child: Text("MENU",textAlign: TextAlign.center, style: TextStyle(
              fontSize: 24,
              color: Colors.white,
              fontFamily: 'Circe',
              fontWeight: FontWeight.w700
            ),),)],),
            //     Row(mainAxisAlignment: MainAxisAlignment.center, children: [Align(alignment: Alignment.center, child: SizedBox(width: 70, height: 70, child: Image.asset('assets/imgs/do-utilizador.png'),),)],),
            //     Row(mainAxisAlignment: MainAxisAlignment.center, children: [Align(alignment: Alignment.center, child: Text("user@gmail.com",textAlign: TextAlign.center, style: TextStyle(
            //   fontSize: 14,
            //   color: Colors.white,
            //   fontFamily: 'Nunito'
            // ),),)],),
